...
If this is not enough try the following as well:

Add-migration LoginFromUmbraco -Context Homework4UmbracoContext
	Update-Database -Context Homework4UmbracoContext
